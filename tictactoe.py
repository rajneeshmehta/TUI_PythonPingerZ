...
def check():
    ...
    if flag ==10:
        ...
        lbl=Label(window,text="Match Tied!!!  Try again :)",font=('Helvetica','15'))
        lbl.grid(row=0,column=0)
       # lbl=Label(window,text="Player 1: X",font=('Helvetica','10'))
       # lbl.grid(row=1,column=0)
       # lbl=Label(window,text="Player 2: O",font=('Helvetica','10'))
...
def win(player):
   ...
   # lbl=Label(window,text="Congratulations\n {}".format(ans),font=('Helvetica','15'))
    lbl=Label(text="Congratulations\n {}".format(ans),font=('Helvetica','15'))
    lbl.grid(row=0,column=0)
    if btn9["text"]==" ":
        btn9["text"]="?"
    if btn8["text"]==" ":
   ...
   # lbl=Label(window,text="Player 2: O",font=('Helvetica','10'))
   # lbl.grid(row=2,column=0)
#    print("Congratulations {}".format(ans))
 #   input()
  #  exit()
